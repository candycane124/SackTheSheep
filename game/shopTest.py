      ...
      for i in shop:
        ...
        if i.rect.collidepoint(*mousePos) and i.mask.get_at(posInMask):
          ...
          if pygame.mouse.get_pressed()[0]:
            ...
            elif str(i) == "Magic Mana Potion II: Greatly improves sprint regeneration, costs 2 and results in [4, 0.2]" and str(shop[4]) == "Magic Mana Potion I: Improves sprint regeneration, costs 1 and results in [4, 0.1]":
